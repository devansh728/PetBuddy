  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Guest */}
        <Animated.View entering={FadeInUp.delay(600).duration(800)} style={styles.guestWrap}>
...
const styles = StyleSheet.create({
  ...
  input: {
    ...
    fontSize: 16, color: '#333', marginBottom: 12,
  },
  error: {
    color: '#FF6B6B', fontSize: 13, textAlign: 'center',
    marginBottom: 8, backgroundColor: 'rgba(255,255,255,0.15)',
  ...
  primaryBtnText: { fontSize: 16, fontWeight: '700', color: '#4F46E5' },
  toggleText: { color: 'rgba(255,255,255,0.8)', textAlign: 'center', fontSize: 14 },
  guestWrap: { marginTop: 24 },
  dividerRow: { flexDirection: 'row', alignItems: 'center', marginBottom: 16 },
  dividerLine: { flex: 1, height: 1, backgroundColor: 'rgba(255,255,255,0.3)' },
  dividerText: { color: 'rgba(255,255,255,0.6)', marginHorizontal: 12 },
  guestBtn: {
    paddingVertical: 14, alignItems: 'center',
    borderWidth: 2, borderColor: 'rgba(255,255,255,0.4)', borderRadius: 12,
  },
  guestBtnText: { fontSize: 16, fontWeight: '600', color: '#fff' },
});
